...
| 0018 | [GAR-393 Slice 2 — `POST /v1/groups/{group_id}/invites`](0018-gar-393-v1-groups-invites.md) | [GAR-393](https://linear.app/chatgpt25/issue/GAR-393) | ⏳ Draft — pendente aprovação. Slice 2 de GAR-393. Invite creation com Argon2id token hash, 409 duplicate check, `Action::MembersManage` authz. 7 tasks (Conflict variant → structs+validation → handler → wiring+OpenAPI → 6 integration tests → 4 authz matrix cases → validation pass). |
