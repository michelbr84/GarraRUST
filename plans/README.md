...
| 0017 | [GAR-393 Slice 1 — `PATCH /v1/groups/{group_id}`](0017-gar-393-v1-groups-patch.md) | [GAR-393](https://linear.app/chatgpt25/issue/GAR-393) | ⏳ Draft — aprovado 2026-04-15 (Florida) após gate 2 (R2 RLS validado empiricamente: `groups` sem RLS, `garraia_app` tem UPDATE grant, `Action::GroupSettings` existe, zero migration nova). Slice 1 de 3 de GAR-393. **`LIST /v1/groups` NÃO está no escopo** — não existe nos endpoints formais da issue, fica para sub-issue/plan separado. Invites/members/setRole/DELETE member = slice 2, plan 0018+. |
