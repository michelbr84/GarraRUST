...
- @imports `docs/adr/` — decisões arquiteturais: 22 ADRs (0001-0022). As 0001-0017, a **0019** (confinamento das tools, #1084), a **0020** (crate `garraia-hardware`, epic #1124 — aceita 2026-09-12, opção A) e a **0022** (identidade do LLM padrão — `z-ai/glm-5.3-flash` via OpenRouter, local como segunda opção, #1180 — aceita 2026-09-13) estão **Accepted**; a **0018** (crate `garraia-embeddings`, #949) e a **0021** (centro de controle do Desktop, #1181) estão **Proposed** — a decisão é do dono, e aceitar a 0018 é o gatilho da remoção. Ver `docs/adr/README.md` para o índice.
