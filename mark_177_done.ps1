...
# Marcar GAR-177 como Done
$mutation = @{
    query = 'mutation { issueUpdate(id: "GAR-177", input: { stateId: "' + $doneState.id + '" }) { success } }'
} | ConvertTo-Json

Write-Host "Marcando GAR-177 como Done..." -ForegroundColor Cyan
