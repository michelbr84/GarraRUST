...
- [x] `POST /v1/groups/{group_id}/task-lists` — plan 0066 / GAR-516 / PR #145 ✅
- [x] `GET /v1/groups/{group_id}/task-lists` — plan 0066 / GAR-516 / PR #145 ✅
- [x] `POST /v1/groups/{group_id}/task-lists/{list_id}/tasks` — plan 0066 / GAR-516 / PR #145 ✅
- [x] `GET /v1/groups/{group_id}/task-lists/{list_id}/tasks?status=...&cursor=...` — plan 0066 / GAR-516 / PR #145 ✅
- [x] `GET /v1/groups/{group_id}/tasks/{task_id}` — plan 0068 / GAR-518 / PR #150 ✅
- [x] `PATCH /v1/groups/{group_id}/tasks/{task_id}` (status, priority, due_at) — plan 0066 / GAR-516 / PR #145 ✅
- [x] `PATCH /v1/groups/{group_id}/task-lists/{list_id}` (name/description/type) — plan 0068 / GAR-518 / PR #150 ✅
- [x] `DELETE /v1/groups/{group_id}/task-lists/{list_id}` (archive) — plan 0068 / GAR-518 / PR #150 ✅
- [x] `DELETE /v1/groups/{group_id}/tasks/{task_id}` (soft delete) — plan 0066 / GAR-516 / PR #145 ✅
- [ ] `POST /v1/groups/{group_id}/tasks/{task_id}/comments` — plan 0069 / GAR-520
- [ ] `GET /v1/groups/{group_id}/tasks/{task_id}/comments` — plan 0069 / GAR-520
- [ ] `DELETE /v1/groups/{group_id}/tasks/{task_id}/comments/{comment_id}` — plan 0069 / GAR-520
