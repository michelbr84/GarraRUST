...
pub struct SearchResult {
    ...
    pub excerpt: String,
    /// The group this item belongs to. `null` only for user-scope
    /// (personal) memory results, whose rows have `group_id IS NULL`.
...
struct MemorySearchRow {
    ...
    score: f32,
    content: String,
    // NULL for user-scope (personal) memories.
