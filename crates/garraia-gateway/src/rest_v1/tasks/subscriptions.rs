...
//! - `POST /v1/groups/{group_id}/tasks/{task_id}/subscriptions` — subscribe current user
//! - `GET /v1/groups/{group_id}/tasks/{task_id}/subscriptions` — list subscribers
//! - `DELETE /v1/groups/{group_id}/tasks/{task_id}/subscriptions` — unsubscribe current user (idempotent)
//!
//! Subject is always `principal.user_id`; POST/DELETE take no body.
