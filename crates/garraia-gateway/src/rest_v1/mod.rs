    ...
    match (
        ...
        (Some(full), Some(_auth)) => {
            ...
            Router::new()
                ...
                // Plan 0283 (GAR-820) — files API slice 9: GET single version.
                .route(
                    "/v1/groups/{group_id}/files/{file_id}/versions",
        ...
        (None, Some(auth)) => {
            ...
            Router::new()
                ...
                // Plan 0283 (GAR-820) — files API slice 9: GET single version, fail-soft 503.
                .route(
                    "/v1/groups/{group_id}/files/{file_id}/versions",
                    get(unconfigured_handler),
                )
        ...
        (_, None) => {
            ...
            Router::new()
                ...
                // Plan 0283 (GAR-820) — files API slice 9: GET single version, no-auth stub.
                .route(
                    "/v1/groups/{group_id}/files/{file_id}/versions",
                    get(unconfigured_handler),
                )
