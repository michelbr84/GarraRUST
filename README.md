...
├── garraia-auth/       # ✅ skeleton (GAR-391a) — IdentityProvider trait + InternalProvider stub + LoginPool BYPASSRLS newtype + Principal/Credential/AuthError. Real verify_credential/JWT/extractor em 391b/c.
