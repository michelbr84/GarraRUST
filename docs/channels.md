...
| Status | **available today** — everything below documents this channel | **pairing available** via `garra whatsapp` ([ADR 0023](adr/0023-whatsapp-dispositivo-vinculado.md)); see [`whatsapp.md`](whatsapp.md) |
