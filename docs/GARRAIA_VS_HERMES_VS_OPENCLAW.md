...
| Prompt injection | 🟡 guard ~20 padrões em web_fetch + tool MCP (#1243 fatia 1) + file_read (#1243 fatia 2); saída de device_read pendente (fatia 3) | 🟡 env filtering, wrapping não confirmado | ✅ wrapping de conteúdo não-confiável |
