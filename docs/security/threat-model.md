...
- Só o wiring do **gateway** tem teste de comportamento do jail.
  ...
  refactor a mesma mutação precisa descartar o parâmetro, e aí não compila sob
  o `-D warnings` do CI (`unused variable: jail`) — gate, não sistema de tipos.
