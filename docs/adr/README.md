...
| [0021](0021-default-llm-identity.md) | `z-ai/glm-5.3-flash` via OpenRouter como LLM padrão; local como segunda opção | ✅ accepted | 2026-09-13 | [#1180](https://github.com/michelbr84/GarraRUST/issues/1180) |
